            ...
            {welcomeStep === 2 && (
              <div className="p-6">
                ...
                <p className="text-center text-[10px] text-muted-foreground mt-3">
                  Meja {tableId} · Pawon Salam Resto · Semarang
                </p>
              </div>
            )}
          </div>
      ...
      <header className="sticky top-0 z-20 bg-card/80 backdrop-blur-md border-b border-border px-4 py-3">
        <div className="flex items-center gap-3">
          ...
          <div className="flex-1 min-w-0">
            <p className="font-bold text-sm text-foreground font-poppins">Pawon Salam Resto</p>
            ...
            {filtered.map(item => {
              ...
              return (
                <button
                  ...
                  className={`bg-card border rounded-xl overflow-hidden text-left transition-all active:scale-95 ${
                    !item.available ? "opacity-40 cursor-not-allowed border-border" : "border-border hover:border-foreground/20"
                  }`}
                >
