  ...
  function handlePrint() {
    ...
    const printContent = tablesToPrint.map(t => `
      <div style="page-break-inside:avoid; display:flex; flex-direction:column; align-items:center; justify-content:center; border:2px dashed #C8A96E; border-radius:20px; padding:32px 28px; margin:16px; width:380px; background:#fff;">
        ...
        <p style="font-family:Poppins,sans-serif; font-size:12px; font-weight:600; color:#C8A96E; margin:0 0 24px; text-transform:uppercase; letter-spacing:2px;">${BRAND_NAME}</p>
        ...
        <img src="/logo-pawon-salam.png" style="height:56px; margin:20px 0 4px; object-fit:contain;" crossorigin="anonymous" />
    ...
    printWindow.document.write(`
      <!DOCTYPE html><html><head><title>QR Menu - ${BRAND_NAME.toUpperCase()}</title>
      <style>
